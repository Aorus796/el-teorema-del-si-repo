...
export const P2_BRIDGES = Object.freeze([
  ...
  createBridge("B2", P2_NODE_IDS.ENTRANCE, P2_NODE_IDS.CLOCK_ISLAND),
  ...
  createBridge("B5", P2_NODE_IDS.MARKET, P2_NODE_IDS.MILL_PATH),
  createBridge("B6", P2_NODE_IDS.NODE_ISLAND, P2_NODE_IDS.MILL_PATH),
  createBridge("B7", P2_NODE_IDS.CLOCK_ISLAND, P2_NODE_IDS.MILL_PATH),
]);
